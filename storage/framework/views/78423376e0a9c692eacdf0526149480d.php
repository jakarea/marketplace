...
} elseif ($_instance->childHasBeenRendered('pW5EBvm')) {
    $componentId = $_instance->getRenderedChildComponentId('pW5EBvm');
    $componentTag = $_instance->getRenderedChildComponentTagName('pW5EBvm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pW5EBvm');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('pW5EBvm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('SEHnTEE')) {
    $componentId = $_instance->getRenderedChildComponentId('SEHnTEE');
    $componentTag = $_instance->getRenderedChildComponentTagName('SEHnTEE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SEHnTEE');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('SEHnTEE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
