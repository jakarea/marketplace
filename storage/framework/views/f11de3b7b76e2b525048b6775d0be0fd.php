        ...
        <?php if($offers->count()): ?>
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-6 gap-y-5">
                <?php $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-lg shadow-sm border px-5 py-6 dark:bg-zinc-800 dark:border-zinc-700 dark:shadow-none" wire:key="account-offers-<?php echo e($offer->uid); ?>">

                        
                        <div class="flex items-center mb-4 space-x-4 rtl:space-x-reverse">
                            <img class="w-10 h-10 rounded-full object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($offer->freelancer->avatar)); ?>" alt="<?php echo e($offer->freelancer->username); ?>">
                            <div class="space-y-1 font-medium dark:text-white">
                                <div class="flex items-center">
                                    <a href="<?php echo e(url('profile', $offer->freelancer->username)); ?>" target="_blank" class="font-bold whitespace-nowrap truncate block max-w-[240px] hover:text-zinc-900 dark:text-white text-sm text-zinc-700" title="<?php echo e($offer->freelancer->username); ?>">
                                        <?php echo e($offer->freelancer->fullname ? $offer->freelancer->fullname : $offer->freelancer->username); ?>
                                ...
                                <div class="flex items-center space-x-3 rtl:space-x-reverse text-xs font-normal text-gray-400 dark:text-zinc-300">
                                    ...
                                    <?php if($offer->freelancer->country): ?>
                                        <p class="flex items-center space-x-1 rtl:space-x-reverse">
                                            <img class="h-4 ltr:pr-0.5 rtl:pl-0.5 -mt-0.5 lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(countryFlag($offer->freelancer->country->code)); ?>" alt="<?php echo e($offer->freelancer->country->name); ?>">
                                            <span class="dark:text-zinc-300 hidden sm:block"><?php echo e($offer->freelancer->country->name); ?></span>
                                        </p>
                                    ...
                                    <p class="flex shrink-0 items-center space-x-1 rtl:space-x-reverse">
                                        <svg aria-hidden="true" class="w-4 h-4 <?php echo e($offer->freelancer->rating() == 0 ? 'text-gray-400' : 'text-amber-500'); ?> -mt-0.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                        <span class="dark:text-zinc-300">
                                            <?php echo e($offer->freelancer->rating()); ?>
                                        ...
                                        <div class="ltr:ml-3 rtl:mr-3">
                                            <p class="text-sm dark:text-zinc-400 text-red-700">
                                                ...
                                                <?php if($offer->rejection_reason): ?>
                                                    <span id="modal-team-rejection-reason-button-<?php echo e($offer->uid); ?>" class="font-bold hover:underline lowercase cursor-pointer"><?php echo app('translator')->get('messages.t_read_more'); ?></span>
                                                <?php endif; ?>
                                            </p>
                                        </div>
                                    </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-team-rejection-reason-container-'.e($offer->uid).'','target' => 'modal-team-rejection-reason-button-'.e($offer->uid).'','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'max-w-md']); ?>
                                        ...
                                        <div class="ltr:ml-3 rtl:mr-3">
                                            <p class="text-sm dark:text-zinc-400 text-pink-700">
                                                ...
                                                <?php if($offer->freelancer_rejection_reason): ?>
                                                    <span id="modal-freelancer-rejection-reason-button-<?php echo e($offer->uid); ?>" class="font-bold hover:underline lowercase cursor-pointer"><?php echo app('translator')->get('messages.t_read_more'); ?></span>
                                                <?php endif; ?>
                                            </p>
                                        </div>
                                    </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-freelancer-rejection-reason-container-'.e($offer->uid).'','target' => 'modal-freelancer-rejection-reason-button-'.e($offer->uid).'','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'max-w-md']); ?>
                                         ...
                                         <?php $__env->slot('content', null, []); ?> 
                                            <div class="text-sm text-gray-500 dark:text-zinc-300 leading-relaxed">
                                                <?php echo e($offer->freelancer_rejection_reason); ?>
...
<?php endif; ?>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="ltr:ml-3 rtl:mr-3">
                                                <p class="text-sm dark:text-zinc-400 text-blue-700">
                                                    ...
                                                    <!-- Space -->
                                                    <span wire:click="confirmAddFunds('<?php echo e($offer->uid); ?>')" class="underline lowercase cursor-pointer animate-ping hover:animate-none ease-linear"><?php echo app('translator')->get('messages.t_add_funds'); ?></span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="ltr:ml-3 rtl:mr-3">
                                            <p class="text-sm dark:text-zinc-400 text-green-700">
                                                ...
                                                <?php if($offer->payment_status === 'funded'): ?>
                                                    <!-- Space -->
                                                    <span wire:click="confirmRelease('<?php echo e($offer->uid); ?>')" class="underline lowercase cursor-pointer animate-ping hover:animate-none ease-linear"><?php echo app('translator')->get('messages.t_release_payment'); ?></span>
                                                <?php endif; ?>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="text-gray-500 dark:text-gray-300 text-sm leading-relaxed">
                            ...
                            <?php if(strlen($offer->message) > 420): ?>
                                <?php echo e(add_3_dots(htmlspecialchars_decode($offer->message), 420)); ?>

                            <?php else: ?>
                                <?php echo e($offer->message); ?>
                        ...
                        <?php if(strlen($offer->message) > 420): ?>
                            <span id="modal-read-more-msg-button-<?php echo e($offer->uid); ?>" class="inline-block mb-5 text-[13px] font-medium text-blue-600 hover:underline dark:text-blue-500 cursor-pointer"><?php echo app('translator')->get('messages.t_read_more'); ?></span>
                        <?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-read-more-msg-container-'.e($offer->uid).'','target' => 'modal-read-more-msg-button-'.e($offer->uid).'','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'max-w-2xl']); ?>

                                
                                 <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_your_offer')); ?> <?php $__env->endSlot(); ?>
                                                    ...
                                                    <li class="flex items-center justify-between py-3 ltr:pl-3 ltr:pr-4 rtl:pr-3 rtl:pl-4 text-sm">
                                                        <div class="flex w-0 flex-1 items-center">
                                                            ...
                                                            <span class="ltr:ml-2 rtl:mr-2 w-0 flex-1 truncate">
                                                                <?php echo e($attachment->uid); ?>.<?php echo e($attachment->file_extension); ?>

                                                            </span>
                                                        </div>
                                                        <div class="ml-4 flex-shrink-0">
                                                            <a href="<?php echo e(url('uploads/offers', $attachment->uid . '.' . $attachment->file_extension)); ?>" class="font-medium text-blue-600 hover:text-blue-500">
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-400 tracking-wide font-normal mt-1 whitespace-nowrap block"><?php echo e(__('messages.t_number_days_for_delivery', ['number' => $offer->delivery_time])); ?></div>

                            
                            <div class="text-xs text-gray-400 tracking-wide font-normal mt-1 whitespace-nowrap block">
                                <?php echo app('translator')->get('messages.t_submitted_ago'); ?> <?php echo e(format_date($offer->submitted_at)); ?>  
                            </div>
                        ...
                        <aside class="bg-slate-50 -mx-5 -my-6 rounded-b-lg px-5 py-4 dark:bg-zinc-600">
                            <div class="flex items-center justify-center space-x-2 rtl:space-x-reverse">
                                ...
                                <div>
                                    <a href="<?php echo e(url('messages/new', $offer->freelancer->username)); ?>" target="_blank" class="block text-gray-600 p-2 border border-slate-200 shadow-sm hover:shadow-none bg-white dark:bg-zinc-700 dark:hover:bg-zinc-600 cursor-pointer dark:border-zinc-500 dark:text-zinc-300 rounded focus:outline-none" data-tooltip-target="tooltip-actions-chat-<?php echo e($offer->uid); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-chat-'.e($offer->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_chat_now'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <?php if($offer->work && $offer->work()->count()): ?>
                                    ...
                                    <div>
                                        <button type="button" id="modal-offer-work-button-<?php echo e($offer->uid); ?>" class="block text-gray-600 p-2 border border-slate-200 shadow-sm hover:shadow-none bg-white dark:bg-zinc-700 dark:hover:bg-zinc-600 cursor-pointer dark:border-zinc-500 dark:text-zinc-300 rounded focus:outline-none" data-tooltip-target="tooltip-actions-files-<?php echo e($offer->uid); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-files-'.e($offer->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_delivered_work'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-offer-work-container-'.e($offer->uid).'','target' => 'modal-offer-work-button-'.e($offer->uid).'','uid' => 'modal_offer_work_'.e($offer->uid).'','placement' => 'center-center','size' => 'max-w-lg']); ?>
                                         ...
                                         <?php $__env->slot('content', null, []); ?> 
                                            ...
                                            <?php $__currentLoopData = $offer->work()->latest()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="mt-6 flex" wire:key="employer-delivered-work-<?php echo e($file->uid); ?>">

                                                    <div class="w-10 flex flex-col items-center">
                                                        
                                                        
                                                        <div class="fiv-sqo fiv-icon-<?php echo e($file->file_extension); ?> text-4xl"></div>
                                                    ...
                                                    <div class="ltr:pl-3 rtl:pr-3">
                                                        ...
                                                        <p class="focus:outline-none text-sm font-semibold leading-normal text-gray-800 pb-1 -mt-1 dark:text-zinc-200">
                                                            <?php echo e($file->uid); ?>.<?php echo e($file->file_extension); ?>
                                                        ...
                                                        <div class="focus:outline-none text-xs leading-3 text-gray-500 pt-1 space-x-2 rtl:space-x-reverse dark:text-zinc-400">
                                                            ...
                                                            <a href="<?php echo e(url('uploads/offers/work', $file->uid . '.' . $file->file_extension)); ?>" class="text-primary-600 hover:underline"><?php echo app('translator')->get('messages.t_download'); ?></a>

                                                            
                                                            <span class="text-gray-300 dark:text-zinc-600" aria-hidden="true">|</span>

                                                            
                                                            <span><?php echo e(format_date($file->created_at)); ?></span>

                                                        </div>

                                                        
                                                        <p class="focus:outline-none pt-4 text-sm leading-4 text-gray-600 whitespace-pre-line dark:text-zinc-200">
                                                            <?php echo e($file->notes); ?>
...
<?php endif; ?>
                                ...
                                <?php if( ($offer->status === 'rejected' || $offer->freelancer_status === 'rejected') && !$offer->isDelivered() && $offer->payment_status === 'pending' ): ?>
                                    ...
                                    <div>
                                        <button wire:click="edit('<?php echo e($offer->uid); ?>')" class="text-gray-600 p-2 border border-slate-200 shadow-sm hover:shadow-none bg-white dark:bg-zinc-700 dark:hover:bg-zinc-600 cursor-pointer dark:border-zinc-500 dark:text-zinc-300 rounded focus:outline-none" data-tooltip-target="tooltip-actions-edit-<?php echo e($offer->uid); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-edit-'.e($offer->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_edit_offer'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-edit-custom-offer-container-'.e($offer->uid).'','target' => 'modal-edit-custom-offer-button-'.e($offer->uid).'','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'max-w-xl']); ?>

                                        
                                         <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_edit_offer')); ?> <?php $__env->endSlot(); ?>
                                                        ...
                                                        <ul class="divide-y divide-gray-200 rounded-md border border-gray-200 dark:divide-zinc-700 dark:border-zinc-700">
                                                            <?php $__currentLoopData = $offer->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <div class="ltr:ml-4 rtl:mr-4 flex flex-shrink-0 space-x-4">
                                                                    ...
                                                                    <button wire:click="confirmRemoveAttachment('<?php echo e($attachment->uid); ?>')" type="button" class="rounded-md bg-transparent font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                                                    ...
                                                                    <a href="<?php echo e(url('uploads/offers', $attachment->uid . '.' . $attachment->file_extension)); ?>" class="rounded-md bg-transparent font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                                                        <?php echo app('translator')->get('messages.t_download'); ?>
                                                                    </a>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'update','text' => ''.e(__('messages.t_update')).'','block' => 0]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <?php if( in_array($offer->status, ['rejected', 'approved']) && !$offer->isDelivered() && ( $offer->isExpired() || in_array($offer->freelancer_status, ['rejected', 'canceled', 'pending'])) ): ?>
                                    <div>
                                        <button wire:click="confirmDelete('<?php echo e($offer->uid); ?>')" class="text-red-500 p-2 border border-slate-200 shadow-sm hover:shadow-none bg-white dark:bg-zinc-700 dark:hover:bg-zinc-600 cursor-pointer dark:border-zinc-500 dark:text-zinc-300 rounded focus:outline-none" data-tooltip-target="tooltip-actions-delete-<?php echo e($offer->uid); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-delete-'.e($offer->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_delete_offer'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
        ...
        <?php else: ?>
            ...
            <div class="border-dashed border-2 dark:border-zinc-500 rounded-md">
                <div class="py-14 px-6 text-center text-sm sm:px-14">
                    ...
                    <p class="mt-4 font-semibold text-slate-700 dark:text-zinc-300 text-[15px]"><?php echo e(__('messages.t_no_submitted_offers_yet')); ?></p>
                    <p class="mt-2 text-slate-500 dark:text-zinc-400 max-w-md mx-auto"><?php echo e(__('messages.t_offers_u_will_submit_freelancers_visible_here')); ?></p>
                </div>
            </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\account\offers\offers.blade.php ENDPATH**/ ?>