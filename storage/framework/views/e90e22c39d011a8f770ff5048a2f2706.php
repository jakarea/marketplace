                ...
                <thead>
                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="freelancer-dashboard-orders-<?php echo e($order->uid); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <a href="<?php echo e(url('profile', $order->order?->buyer->username)); ?>" target="_blank" class="text-gray-900 hover:text-primary-600 dark:text-gray-100 text-sm font-medium">
...
</div><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\seller\orders\orders.blade.php ENDPATH**/ ?>