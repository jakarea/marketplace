            ...
            <div class="mb-2 font-normal text-sm leading-relaxed text-gray-500 dark:text-gray-300">
                <?php if(strlen($view_data['bid']['message']) > 250): ?>
                    <div class="break-all">
                        ...
                        <span style="word-break: break-word;" id="bid-card-message-short-<?php echo e($view_data['bid']['id']); ?>">
                            <?php echo e(add_3_dots(htmlspecialchars_decode($view_data['bid']['message']), 220, null)); ?>

                        </span>

                        
                        <span style="word-break: break-word;" id="bid-card-message-long-<?php echo e($view_data['bid']['id']); ?>" class="hidden">
                    ...
                    <script>
                        const target_btn_<?php echo e($view_data['bid']['id']); ?>   = document.getElementById("bid-card-message-more-less-button-<?php echo e($view_data['bid']['id']); ?>");
                        const target_short_<?php echo e($view_data['bid']['id']); ?> = document.getElementById("bid-card-message-short-<?php echo e($view_data['bid']['id']); ?>");
                        const target_long_<?php echo e($view_data['bid']['id']); ?>  = document.getElementById("bid-card-message-long-<?php echo e($view_data['bid']['id']); ?>");
                        target_btn_<?php echo e($view_data['bid']['id']); ?>.onclick = function() {
                            if (target_long_<?php echo e($view_data['bid']['id']); ?>.classList.contains('hidden')) {
                                target_short_<?php echo e($view_data['bid']['id']); ?>.classList.add('hidden');
                                target_long_<?php echo e($view_data['bid']['id']); ?>.classList.remove('hidden');
                                target_btn_<?php echo e($view_data['bid']['id']); ?>.innerHTML = "<?php echo e(__('messages.t_less')); ?>";
                            } else {
                                target_short_<?php echo e($view_data['bid']['id']); ?>.classList.remove('hidden');
                                target_long_<?php echo e($view_data['bid']['id']); ?>.classList.add('hidden');
                                target_btn_<?php echo e($view_data['bid']['id']); ?>.innerHTML = "<?php echo e(__('messages.t_more')); ?>";
                            }
                        }
                    </script>
                <?php else: ?>
...
</div><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\cards\bid.blade.php ENDPATH**/ ?>