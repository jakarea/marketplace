...
} elseif ($_instance->childHasBeenRendered('Z9dRtq4')) {
    $componentId = $_instance->getRenderedChildComponentId('Z9dRtq4');
    $componentTag = $_instance->getRenderedChildComponentTagName('Z9dRtq4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Z9dRtq4');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.overview', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('Z9dRtq4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('5vfQytN')) {
    $componentId = $_instance->getRenderedChildComponentId('5vfQytN');
    $componentTag = $_instance->getRenderedChildComponentTagName('5vfQytN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5vfQytN');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.pricing', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('5vfQytN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('UHfKZDc')) {
    $componentId = $_instance->getRenderedChildComponentId('UHfKZDc');
    $componentTag = $_instance->getRenderedChildComponentTagName('UHfKZDc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UHfKZDc');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.requirements', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('UHfKZDc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('wtSostL')) {
    $componentId = $_instance->getRenderedChildComponentId('wtSostL');
    $componentTag = $_instance->getRenderedChildComponentTagName('wtSostL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wtSostL');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.gallery', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('wtSostL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
</div><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\seller\gigs\options\edit.blade.php ENDPATH**/ ?>