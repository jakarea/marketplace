...
unset($__errorArgs, $__bag); ?>
					...
					<?php if(settings('security')->is_recaptcha): ?>
						<div class="col-span-12" wire:ignore>
							<div class="g-recaptcha" data-sitekey="<?php echo e(config('recaptcha.site_key')); ?>" data-theme="<?php echo e(current_theme()); ?>"></div>
						</div>
					<?php endif; ?>
			...
			<div class="mt-6">
				<ul class="list-disc list-inside text-slate-500 text-[13px] space-y-2 dark:text-gray-300">
					...
					<li>
						<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('auth/register')); ?>">
					...
					<li>
						<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('auth/password/reset')); ?>">
					...
					<li>
						<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('auth/request')); ?>">
					...
					<?php if(settings('footer')->privacy && settings('footer')->terms): ?>
						...
						<li>
							<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('page', settings('footer')->privacy->slug)); ?>"><?php echo e(settings('footer')->privacy->title); ?></a>
						</li>

						
						<li>
							<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('page', settings('footer')->terms->slug)); ?>"><?php echo e(settings('footer')->terms->title); ?></a>
						</li>
					<?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\auth\login.blade.php ENDPATH**/ ?>