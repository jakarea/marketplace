...
<?php endif; ?>
    ...
    <div class="p-4 md:p-5 rounded text-orange-700 bg-orange-100 mb-6">
        <div class="flex items-center">
            ...
            <h3 class="font-medium text-sm grow">
                The following new payment gateways will be active in the following days.
            </h3>
        </div>
    </div>
            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate -mt-2">
                ...
                <thead>
                    <?php $__empty_1 = true; $__currentLoopData = $gateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="admin-dashboard-gateways-<?php echo e($g->uid); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-64 rtl:text-right">
                                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                    ...
                                    <img class="w-8 h-8 rounded-full object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($g->logo)); ?>" alt="<?php echo e($g->name); ?>">
                                    ...
                                    <div class="space-y-1 font-medium dark:text-white">
                                        <div class="flex items-center space-x-1 rtl:space-x-reverse">
                                            ...
                                            <?php if($g->country): ?>
                                                <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(countryFlag($g->country)); ?>" alt="<?php echo e($g->country); ?>" class="lazy h-4.5">
                                            <?php endif; ?>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <label class="relative inline-flex items-center mt-2.5 cursor-pointer">
                                    <input type="checkbox" wire:change="update('<?php echo e($g->slug); ?>')" <?php echo e($g->is_active ? 'checked' : ''); ?> class="sr-only peer">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-edit-'.e($g->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_settings'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\admin\services\payment\payment.blade.php ENDPATH**/ ?>