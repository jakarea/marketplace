...
<html lang="<?php echo e(app()->getLocale(), false); ?>" dir="<?php echo e(config()->get('direction'), false); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['dark' => current_theme() === 'dark']); ?>">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/bootstrap.min.css'), false); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/slick.css'), false); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/style.css'), false); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/home.css'), false); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/responsive.css'), false); ?>">
...
} elseif ($_instance->childHasBeenRendered('wqHjWqb')) {
    $componentId = $_instance->getRenderedChildComponentId('wqHjWqb');
    $componentTag = $_instance->getRenderedChildComponentTagName('wqHjWqb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wqHjWqb');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('wqHjWqb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('w33KqAD')) {
    $componentId = $_instance->getRenderedChildComponentId('w33KqAD');
    $componentTag = $_instance->getRenderedChildComponentTagName('w33KqAD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('w33KqAD');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('w33KqAD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="http://riverr.local/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
        ...
        <script src="<?php echo e(url('public/assets/js/bootstrap.bundle.min.js'), false); ?>"></script>
        <script src="<?php echo e(url('public/assets/js/jquery.min.js'), false); ?>"></script>

        <script src="<?php echo e(url('public/assets/js/slick.min.js'), false); ?>"></script>
        <script src="<?php echo e(url('public/assets/js/config.js'), false); ?>"></script>
        <script src="<?php echo e(url('public/assets/js/custom.js'), false); ?>"></script>
