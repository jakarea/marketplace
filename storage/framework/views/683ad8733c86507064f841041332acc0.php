            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate -mt-2">
                ...
                <thead>
                    <?php $__empty_1 = true; $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="admin-dashboard-offers-<?php echo e($offer->uid); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-64 rtl:text-right">
                                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                    <img class="w-10 h-10 rounded-md object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($offer->buyer->avatar)); ?>" alt="<?php echo e($offer->buyer->username); ?>">
                                    <div class="space-y-1 font-medium dark:text-white">
                                        <div class="flex items-center space-x-1 rtl:space-x-reverse">

                                            
                                            <a href="<?php echo e(url('profile', $offer->buyer->username)); ?>" target="_blank" class="font-bold whitespace-nowrap truncate block max-w-[240px] hover:text-zinc-900 dark:text-white text-sm text-zinc-700" title="<?php echo e($offer->buyer->username); ?>">
                                                <?php echo e($offer->buyer->fullname ? $offer->buyer->fullname : $offer->buyer->username); ?>
                                        ...
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse text-xs font-normal text-gray-400 dark:text-zinc-300">
                                            ...
                                            <a href="<?php echo e(admin_url('users/details/' . $offer->buyer->uid)); ?>" class="dark:text-zinc-300 whitespace-nowrap hover:text-gray-600 hover:underline">
                                            ...
                                            <a href="<?php echo e(url('profile', $offer->buyer->username)); ?>" target="_blank" class="dark:text-zinc-300 whitespace-nowrap hover:text-gray-600 hover:underline">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-64 rtl:text-right">
                                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                    <img class="w-10 h-10 rounded-md object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($offer->freelancer->avatar)); ?>" alt="<?php echo e($offer->freelancer->username); ?>">
                                    <div class="space-y-1 font-medium dark:text-white">
                                        <div class="flex items-center space-x-1 rtl:space-x-reverse">
                                        ...
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse text-xs font-normal text-gray-400 dark:text-zinc-300">
                                            ...
                                            <a href="<?php echo e(admin_url('users/details/' . $offer->freelancer->uid)); ?>" class="dark:text-zinc-300 whitespace-nowrap hover:text-gray-600 hover:underline">
                                                <?php echo app('translator')->get('messages.t_user_details'); ?>   
                                            </a>
                                            ...
                                            <a href="<?php echo e(url('profile', $offer->freelancer->username)); ?>" target="_blank" class="dark:text-zinc-300 whitespace-nowrap hover:text-gray-600 hover:underline">
                                                <?php echo app('translator')->get('messages.t_view_profile'); ?>    
                                            </a>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                ...
                                <div class="text-xs text-gray-400 tracking-wide font-normal mt-1 whitespace-nowrap"><?php echo e(__('messages.t_number_days_for_delivery', ['number' => $offer->delivery_time])); ?></div>
                            </td>
                                        ...
                                        <div class="bg-yellow-100 text-yellow-600 px-4 leading-9 h-9 rounded-3xl font-medium text-xs flex items-center space-x-3 rtl:space-x-reverse">
                                            ...
                                            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                                                ...
                                                <div>
                                                    ...
                                                    <button type="button" data-tooltip-target="tooltip-actions-approve-<?php echo e($offer->uid); ?>" id="modal-approve-offer-button-<?php echo e($offer->uid); ?>" class="flex items-center justify-center h-6 w-6 rounded-full border border-transparent bg-white text-yellow-600 hover:bg-transparent hover:border-yellow-600">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-approve-'.e($offer->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_approve'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                                ...
                                                <div>
                                                    ...
                                                    <button type="button" data-tooltip-target="tooltip-actions-reject-<?php echo e($offer->uid); ?>" id="modal-reject-offer-button-<?php echo e($offer->uid); ?>" class="flex items-center justify-center h-6 w-6 rounded-full border border-transparent bg-white text-yellow-600 hover:bg-transparent hover:border-yellow-600">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-reject-'.e($offer->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_reject'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php endif; ?>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="text-gray-600 dark:text-gray-100 text-sm font-medium whitespace-nowrap">
                                    <?php echo e(format_date($offer->created_at)); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-details-'.e($offer->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_offer_details'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php endif; ?>
                                    ...
                                    <?php if($offer->freelancer_status === 'completed' && $offer->payment_status === 'funded'): ?>
                                        <div>
                                            <button type="button" wire:click="confirmRelease('<?php echo e($offer->uid); ?>')" data-tooltip-target="tooltip-actions-release-payment-<?php echo e($offer->uid); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-700 dark:hover:bg-zinc-900 dark:hover:border-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-release-payment-'.e($offer->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_release_payment'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php endif; ?>
                                    ...
                                    <div>
                                        <button type="button" wire:click="confirmDelete('<?php echo e($offer->uid); ?>')" data-tooltip-target="tooltip-actions-delete-payment-<?php echo e($offer->uid); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-red-600 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-700 dark:hover:bg-zinc-900 dark:hover:border-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-delete-payment-'.e($offer->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_delete_offer'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-approve-offer-container-'.e($offer->uid).'','target' => 'modal-approve-offer-button-'.e($offer->uid).'','uid' => 'modal_approve_offer_'.e($offer->uid).'','placement' => 'center-center','size' => 'max-w-md']); ?>

                            
                             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_approve_offer')); ?> <?php $__env->endSlot(); ?>
                             ...
                             <?php $__env->slot('footer', null, []); ?> 
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <button
                                        type="button" 
                                        wire:click="approve('<?php echo e($offer->uid); ?>')"
                                        ...
                                        <div wire:loading wire:target="approve('<?php echo e($offer->uid); ?>')">
                                        ...
                                        <div wire:loading.remove wire:target="approve('<?php echo e($offer->uid); ?>')">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-reject-offer-container-'.e($offer->uid).'','target' => 'modal-reject-offer-button-'.e($offer->uid).'','uid' => 'modal_reject_offer_'.e($offer->uid).'','placement' => 'center-center','size' => 'max-w-md']); ?>

                            
                             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_reject_offer')); ?> <?php $__env->endSlot(); ?>
...
unset($__errorArgs, $__bag); ?>
                             ...
                             <?php $__env->slot('footer', null, []); ?> 
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <button
                                        type="button" 
                                        wire:click="reject('<?php echo e($offer->uid); ?>')"
                                        wire:loading.attr="disabled"
                                        ...
                                        <div wire:loading wire:target="reject('<?php echo e($offer->uid); ?>')">
                                            <svg role="status" class="inline w-4 h-4 text-gray-700 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#E5E7EB"/>
                                                <path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="currentColor"/>
                                            </svg>
                                        ...
                                        <div wire:loading.remove wire:target="reject('<?php echo e($offer->uid); ?>')">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-offer-details-container-'.e($offer->uid).'','target' => 'modal-offer-details-button-'.e($offer->uid).'','uid' => 'modal_offer_details_'.e($offer->uid).'','placement' => 'center-center','size' => 'max-w-xl']); ?>

                            
                             <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_offer_details')); ?> <?php $__env->endSlot(); ?>
                                ...
                                <div class="w-full divide-y divide-gray-300 space-y-8">
                                    ...
                                    <?php if($offer->admin_rejection_reason): ?>
                                        <div class="w-full">
                                            ...
                                            <span class="text-slate-500 text-sm">
                                                <?php echo e($offer->admin_rejection_reason); ?>   
                                            </span>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if($offer->delivered_at): ?>
                                        <div class="w-full">
                                            ...
                                            <span class="text-gray-400 text-sm"><?php echo e(format_date($offer->delivered_at, config('carbon-formats.F_j,_Y_h_:_i_A'))); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if($offer->canceled_at): ?>
                                        <div class="w-full">
                                            ...
                                            <span class="text-gray-400 text-sm"><?php echo e(format_date($offer->canceled_at, config('carbon-formats.F_j,_Y_h_:_i_A'))); ?></span>
                                        </div>
                                    <?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\admin\offers\offers.blade.php ENDPATH**/ ?>