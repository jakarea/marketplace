...
} elseif ($_instance->childHasBeenRendered('Zms0g7r')) {
    $componentId = $_instance->getRenderedChildComponentId('Zms0g7r');
    $componentTag = $_instance->getRenderedChildComponentTagName('Zms0g7r');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Zms0g7r');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $item->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('Zms0g7r', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\account\reviews\options\create.blade.php ENDPATH**/ ?>