...
<?php endif; ?>
                ...
                <div class="divide-y divide-gray-200 dark:divide-zinc-700 lg:col-span-9">
                    ...
                    <div class="py-6 px-4 sm:p-6 lg:pb-8">
                        ...
                        <div class="mb-14">
                            <h2 class="text-base leading-6 font-bold text-gray-900 dark:text-gray-100"><?php echo e(__('messages.t_browser_sessions')); ?></h2>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300"><?php echo e(__('messages.t_browser_sessions_subtitle')); ?></p>
                        </div>
                            ...
                            <?php if(count($this->sessions) > 0): ?>
                                <div class="w-full space-y-5 divide-y divide-gray-200 dark:divide-zinc-700">
                                    ...
                                    <?php $__currentLoopData = $this->sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between <?php echo e(!$loop->first ? 'pt-5' : ''); ?>">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ltr:pl-3 rtl:pr-3">
                                                    ...
                                                    <p class="focus:outline-none text-sm font-medium leading-none text-gray-800 dark:text-gray-100">
                                                        <?php echo e($session->agent->platform() ? $session->agent->platform() : __('messages.t_unknown')); ?> - <?php echo e($session->agent->browser() ? $session->agent->browser() : __('messages.t_unknown')); ?>
                                            ...
                                            <?php elseif($session->last_active): ?>
                                                <p class="focus:outline-none text-xs font-medium leading-none text-right text-zinc-600 dark:text-zinc-400">
                                                    <?php echo e(__('messages.t_last_activity')); ?> <?php echo e(format_date($session->last_active)); ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <div class="relative">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <img src="<?php echo e(url('public/img/svg/lock.svg')); ?>" class="w-44 h-44 p-3 rounded-full border shadow-xs">
...
</main><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\account\sessions\sessions.blade.php ENDPATH**/ ?>