...
unset($__errorArgs, $__bag); ?>
			...
			<div class="mt-6">
				<ul class="list-disc list-inside text-slate-500 text-[13px] space-y-2 dark:text-gray-300">
					...
					<li>
						<a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline" href="<?php echo e(url('auth/login')); ?>">
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\auth\register.blade.php ENDPATH**/ ?>