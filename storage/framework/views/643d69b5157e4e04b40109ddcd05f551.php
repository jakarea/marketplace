                                        ...
                                        <li>
                                            ...
                                            <ul class="-mx-4 mt-2 text-sm text-gray-700 dark:text-gray-400">
                                                ...
                                                <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="group flex cursor-default select-none items-center px-4 py-2">
                                                        <a href="<?php echo e(url('search?q=' . $tag->name)); ?>" class="flex items-center">
...
} elseif ($_instance->childHasBeenRendered('bm1u3Uk')) {
    $componentId = $_instance->getRenderedChildComponentId('bm1u3Uk');
    $componentTag = $_instance->getRenderedChildComponentTagName('bm1u3Uk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bm1u3Uk');
} else {
    $response = \Livewire\Livewire::mount('main.partials.languages');
    $html = $response->html();
    $_instance->logRenderedChild('bm1u3Uk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('1T2r2h9')) {
    $componentId = $_instance->getRenderedChildComponentId('1T2r2h9');
    $componentTag = $_instance->getRenderedChildComponentTagName('1T2r2h9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1T2r2h9');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('1T2r2h9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('Iv6atP2')) {
    $componentId = $_instance->getRenderedChildComponentId('Iv6atP2');
    $componentTag = $_instance->getRenderedChildComponentTagName('Iv6atP2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Iv6atP2');
} else {
    $response = \Livewire\Livewire::mount('main.partials.cart');
    $html = $response->html();
    $_instance->logRenderedChild('Iv6atP2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <div 
                            ...
                            class="absolute top-full ltr:right-0 rtl:left-0 w-60 mt-3 bg-white dark:bg-zinc-800 rounded-lg shadow-md ring-1 ring-gray-900 ring-opacity-5 font-normal text-sm text-gray-900 divide-y divide-gray-100 dark:divide-zinc-700 z-40">
                                ...
                                <?php if(settings('publish')->enable_custom_offers): ?>
                                    <div class="py-1.5 px-3.5">
                                        <a href="<?php echo e(url('account/offers')); ?>" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                            ...
                                            <span class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">
                                                <?php echo e(__('messages.t_submitted_offers')); ?>
...
<?php endif; ?>
                    ...
                    <?php if(settings('projects')->is_enabled): ?>
                        <a href="<?php echo e(url('explore/projects')); ?>" class="py-2 px-5 block text-gray-500 dark:text-gray-200 font-semibold text-sm">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\includes\header.blade.php ENDPATH**/ ?>