            ...
            <div class="h-screen">
                ...
                <div class="py-10 space-y-6">
                    ...
                    <?php if($notifications['count_pending_offers']): ?>
                        <a href="<?php echo e(admin_url('offers')); ?>" class="w-full p-3 bg-violet-100 text-violet-700 rounded flex items-center hover:bg-opacity-50">
                            ...
                            <div class="ltr:pl-3 rtl:pr-3 w-full flex items-center justify-between">
                                ...
                                <p class="bg-violet-200 border border-violet-300 flex focus:outline-none font-bold h-6 items-center justify-center p-1 rounded-full text-xs w-6">
                                    <?php echo e($notifications['count_pending_offers']); ?>
...
} elseif ($_instance->childHasBeenRendered('pRUeSHu')) {
    $componentId = $_instance->getRenderedChildComponentId('pRUeSHu');
    $componentTag = $_instance->getRenderedChildComponentTagName('pRUeSHu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pRUeSHu');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('pRUeSHu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('N9Lknd3')) {
    $componentId = $_instance->getRenderedChildComponentId('N9Lknd3');
    $componentTag = $_instance->getRenderedChildComponentTagName('N9Lknd3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('N9Lknd3');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('N9Lknd3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\admin\layout\app.blade.php ENDPATH**/ ?>