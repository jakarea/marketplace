    ...
    <?php if($user->availability): ?>
        <div class="p-4 md:p-5 rounded text-orange-700 bg-orange-100 mb-6">
            <div class="flex items-center mb-2">
                ...
                <h3 class="font-semibold"><?php echo e(__('messages.t_this_user_is_not_available_right_now_msg', ['date' => format_date($user->availability?->expected_available_date, config('carbon-formats.F_j,_Y'))])); ?></h3>
            </div>
                ...
                <div class="flex items-center space-x-5 rtl:space-x-reverse flex-col md:flex-row">
                    ...
                    <div class="flex-shrink-0 mb-5 md:mb-0">
                        <div class="inline-block relative">
                            <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($user->avatar)); ?>" alt="<?php echo e($user->username); ?>" class="inline-block w-16 h-16 rounded-full object-cover lazy">
                        </div>
                    </div>
                    ...
                    <div>
                            ...
                            <div class="flex items-center mb-2 justify-center md:justify-normal">
                                ...
                                <?php if($user->fullname): ?>
                                    <h1 class="text-base font-extrabold text-gray-700 dark:text-zinc-100"><?php echo e($user->fullname); ?></h1>
                                <?php else: ?>
                                    <h1 class="text-base font-extrabold text-gray-700 dark:text-zinc-100"><?php echo e($user->username); ?></h1>
                                <?php endif; ?>

                                
                                <?php if($user->status === 'verified'): ?>
                                    <div>
                                        <img data-popover-target="popover-profile-verified-<?php echo e($user->uid); ?>" data-popover-placement="bottom" class="ltr:ml-0.5 rtl:mr-0.5 h-4 w-4 -mt-0.5" src="<?php echo e(url('public/img/auth/verified-badge.svg')); ?>" alt="<?php echo e(__('messages.t_account_verified')); ?>">
                                        <div data-popover id="popover-profile-verified-<?php echo e($user->uid); ?>" role="tooltip" class="absolute z-50 invisible inline-block w-64 text-xs tracking-wide text-gray-600 transition-opacity duration-300 bg-gray-50 border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800 leading-relaxed">
                                            <div class="px-3 py-2">
                            ...
                            <div class="flex items-center space-x-2 rtl:space-x-reverse mb-4 md:mb-0 justify-center md:justify-normal space-y-1 md:space-y-0">

                                
                                <?php if($user->level): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border px-3 py-1 text-xs font-normal tracking-wide" style="color: <?php echo e($user->level->level_color); ?>;border-color: <?php echo e($user->level->level_color); ?>;">
                                        <span><?php echo e($user->level->title); ?></span>
                                    </span>
                                <?php endif; ?>

                                
                                <?php if($user->account_type === 'seller' && !$user->availability): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border border-purple-500 px-3 py-1 text-xs font-normal tracking-wide text-purple-500">
                                ...
                                <?php if($user->isOnline()): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border border-green-500 px-3 py-1 text-xs font-normal tracking-wide text-green-500">
                                ...
                                <?php if(!$user->isOnline()): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border border-red-500 px-3 py-1 text-xs font-normal tracking-wide text-red-500">
                    ...
                    <ul class="list-disc list-inside text-gray-500 dark:text-zinc-300 text-sm space-y-3">
                        ...
                        <?php if($user->headline): ?>
                            <li>
                                <div class="inline-flex items-center space-x-1 rtl:space-x-reverse absolute">
                                    ...
                                    <span><?php echo e($user->headline); ?></span>
                                </div>
                            </li>
                        <?php endif; ?>
                            ...
                            <li>
                                <div class="inline-flex items-center space-x-1 rtl:space-x-reverse absolute">
                                    <div class="w-5 flex justify-center">
                                        <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('public/img/flags/' . strtolower($user->country->code) . '.svg')); ?>" alt="<?php echo e($user->country->name); ?>" class="lazy h-3">
                                    </div>
                                    <div>
                                        <?php if($user->city): ?>
                                            <span class="ltr:pr-1 rtl:pl-1"><?php echo e($user->city); ?>,</span>
                                        <?php endif; ?>
                        ...
                        <?php if($user->timezone): ?>
                            ...
                            <li>
                                <div class="inline-flex items-center space-x-1 rtl:space-x-reverse absolute">
                                    ...
                                    <span class="lowercase"><?php echo e($now); ?> – <?php echo app('translator')->get('messages.t_local_time'); ?></span>
                            ...
                            <li>
                                <div class="inline-flex items-center space-x-1 rtl:space-x-reverse absolute">
                                    ...
                                    <div>
                                        ...
                                        <?php echo e(format_date($last_delivery)); ?>
                        ...
                        <li>
                            <div class="inline-flex items-center space-x-1 rtl:space-x-reverse absolute">
                                ...
                                <span><?php echo app('translator')->get('messages.t_member_since'); ?> <?php echo e(format_date($user->created_at, config('carbon-formats.F_j,_Y'))); ?></span>
                            </div>
                        </li>
                ...
                <?php if($seller_loyalty): ?>
                    <div class="px-4 pt-8 flex items-center space-x-3 rtl:space-x-reverse">
                        <div class="flex flex-shrink-0 h-16 items-center justify-center w-16">
                            <img src="<?php echo e(url('public/img/svg/reward-icon.svg')); ?>" alt="<?php echo e($user->username); ?>">
                        </div>
                        <div class="flex flex-col">
                            ...
                            <p class="text-[13px] text-gray-400 dark:text-zinc-400 mt-1">
                                <?php echo e($user->username); ?> <?php echo app('translator')->get('messages.t_has_an_exceptional_number_of_repeat_buyers'); ?>
                            </p>
                        </div>
                    </div>
                <?php endif; ?>
                            ...
                            <?php $__currentLoopData = $user->languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex justify-between items-center">
                                    <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                        ...
                                        <span class="capitalize"><?php echo e($lang->name); ?></span>
                                    </span>
                                    <span class="text-gray-500 dark:text-zinc-400 text-sm">
                                        
                                        <span><?php echo e(__('messages.t_' . $lang->level)); ?></span>
                                    </span>
                                </li>
                        ...
                        <ul class="space-y-3">
                            ...
                            <?php if($user_accounts->facebook_profile): ?>
                                <li class="flex justify-between items-center">
                                    ...
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->facebook_profile))); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                            ...
                            <?php if($user_accounts->twitter_profile): ?>
                                <li class="flex justify-between items-center">
                                    ...
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->twitter_profile))); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if($user_accounts->dribbble_profile): ?>
                                <li class="flex justify-between items-center">
                                    ...
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->dribbble_profile))); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if($user_accounts->stackoverflow_profile): ?>
                                <li class="flex justify-between items-center">
                                    ...
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->stackoverflow_profile))); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if($user_accounts->github_profile): ?>
                                <li class="flex justify-between items-center">
                                    ...
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->github_profile))); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if($user_accounts->youtube_profile): ?>
                                <li class="flex justify-between items-center">
                                    ...
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->youtube_profile))); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                            ...
                            <?php if($user_accounts->vimeo_profile): ?>
                                <li class="flex justify-between items-center">
                                    ...
                                    <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->vimeo_profile))); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                        <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>
                                        <span><?php echo app('translator')->get('messages.t_visit_profile'); ?></span>
                                    </a>
                                </li>
                    ...
                    <section class="px-5 py-8">
                        ...
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <span class="flex items-center gap-4 text-sm rounded text-slate-500">
                                ...
                                <span class="text-base font-bold text-amber-500"><?php echo e($user_rating['value']); ?> <?php echo app('translator')->get('messages.t_out_of_5'); ?></span>
                            ...
                            <div class="flex flex-col w-full gap-4 pt-6">
                                ...
                                <span class="flex items-center w-full gap-2">
                                    ...
                                    <progress max="100" value="<?php echo e($user_rating['stars_5'] * 100 / $user_rating['total']); ?>" class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400"><?php echo e($user_rating['stars_5'] * 100 / $user_rating['total']); ?>%</progress>
                                    <span class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300"><?php echo e($user_rating['stars_5']); ?></span>
                                </span>
                                ...
                                <span class="flex items-center w-full gap-2">
                                    ...
                                    <progress max="100" value="<?php echo e($user_rating['stars_4'] * 100 / $user_rating['total']); ?>" class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400"><?php echo e($user_rating['stars_4'] * 100 / $user_rating['total']); ?>%</progress>
                                    <span class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300"><?php echo e($user_rating['stars_4']); ?></span>
                                </span>
                                ...
                                <span class="flex items-center w-full gap-2">
                                    ...
                                    <progress max="100" value="<?php echo e($user_rating['stars_3'] * 100 / $user_rating['total']); ?>" class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400"><?php echo e($user_rating['stars_3'] * 100 / $user_rating['total']); ?>%</progress>
                                    <span class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300"><?php echo e($user_rating['stars_3']); ?></span>
                                </span>
                                ...
                                <span class="flex items-center w-full gap-2">
                                    ...
                                    <span class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300"><?php echo e($user_rating['stars_2']); ?></span>
                                </span>
                                ...
                                <span class="flex items-center w-full gap-2">
                                    ...
                                    <progress max="100" value="<?php echo e($user_rating['stars_1'] * 100 / $user_rating['total']); ?>" class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400"><?php echo e($user_rating['stars_1'] * 100 / $user_rating['total']); ?>%</progress>
                                    <span class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300"><?php echo e($user_rating['stars_1']); ?></span>
                                </span>
            ...
            <div class="bg-white shadow-sm shadow-gray-100 border border-slate-100 dark:border-transparent dark:shadow-none rounded-lg dark:bg-zinc-800 col-span-2 py-6 divide-y dark:divide-zinc-700 space-y-8">
                ...
                <?php if($user->description): ?>
                    <section class="px-7">
                        ...
                        <div class="text-sm text-gray-500 dark:text-zinc-400 leading-relaxed <?php echo e($enable_more_less ? 'max-h-16 overflow-hidden' : ''); ?>" id="profile-description-content">
                    ...
                    <section class="px-7 pt-8">
                        ...
                        <div class="grid grid-cols-1 gap-4 lg:gap-8 divide-y dark:divide-zinc-700">
                            <?php $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex flex-col overflow-hidden [&:not(:first-child)]:pt-4 lg:[&:not(:first-child)]:pt-8" wire:key="profile-gigs-<?php echo e($gig->uid); ?>">
                                    <div class="flex flex-col grow md:flex-row md:space-x-6 md:space-y-0 rtl:space-x-reverse space-y-4 w-full">

                                        
                                        <a href="<?php echo e(url('service', $gig->slug)); ?>" class="flex-none md:w-32 h-min rounded-lg overflow-hidden">
                                            <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($gig->thumbnail)); ?>" alt="<?php echo e($gig->title); ?>" class="rounded-lg object-cover w-full h-32 hover:origin-center hover:scale-110 hover:rotate-3 transition duration-500 lazy">
                                        </a>

                                        <div class="grow">

                                            
                                            <a href="<?php echo e(url('service', $gig->slug)); ?>" class="block font-extrabold md:text-base text-black hover:text-gray-500 mb-2 dark:text-zinc-200 dark:hover:text-white">
                                            ...
                                            <?php if($gig->delivery_time): ?>
                                                <div class="flex items-center space-x-1 rtl:space-x-reverse text-xs mb-2 text-gray-500 dark:text-gray-400 tracking-wide font-medium lowercase">
                                                    ...
                                                    <?php if($gig->delivery_time == 1): ?>
                                                        <span><?php echo e($gig->delivery_time); ?> <?php echo app('translator')->get('messages.t_day_delivery'); ?></span>
                                                    <?php else: ?>
                                                        <span><?php echo e($gig->delivery_time); ?> <?php echo app('translator')->get('messages.t_days_delivery'); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <div class="text-[13px] text-gray-400 font-normal lowercase mt-2 italic">
                                                ( <?php echo e($gig->counter_reviews); ?> )
                            ...
                            <div class="mt-6">
                                <button type="button" wire:click="loadMoreGigs" wire:loading.attr="disabled" wire:target="loadMoreGigs" class="space-x-2 rtl:space-x-reverse rounded border font-semibold enabled:focus:outline-none px-3 py-2 leading-5 text-sm border-indigo-200 bg-indigo-200 text-indigo-700 enabled:hover:text-indigo-700 enabled:hover:bg-indigo-300 enabled:hover:border-indigo-300 enabled:focus:ring enabled:focus:ring-indigo-500 enabled:focus:ring-opacity-50 active:bg-indigo-200 active:border-indigo-200 block w-full disabled:bg-zinc-200 disabled:border-zinc-200 disabled:text-zinc-600 disabled:hover:bg-zinc-200 disabled:cursor-not-allowed">
                                    ...
                                    <div wire:loading.remove wire:target="loadMoreGigs">
                                        <?php echo e(htmlspecialchars_decode(__('messages.t_load_more'))); ?>
                ...
                <?php if(count($projects)): ?>
                    <section class="px-7 pt-8">
                                    ...
                                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                                        <a href="<?php echo e(url('profile/' . $project->user->username . '/portfolio/' . $project->slug)); ?>" target="_blank">
                                            <div class="h-min overflow-hidden rounded-md">
                                                <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($project->thumbnail)); ?>" class="rounded-md object-cover h-36 w-full group-hover:origin-center group-hover:scale-110 group-hover:rotate-3 transition duration-500 lazy" alt="<?php echo e($project->title); ?>">
                                            </div>
                                        </a>
                                        <div class="content pt-3">
                                            <h5 class="mb-1">
                                                <a href="<?php echo e(url('profile/' . $project->user->username . '/portfolio/' . $project->slug)); ?>" target="_blank" class="hover:text-primary-600 transition-all duration-500 font-medium text-sm block dark:text-zinc-200 dark:hover:text-primary-600">
                                                    <?php echo e(htmlspecialchars_decode($project->title)); ?>
                        ...
                        <?php if(count($projects) > 6): ?>
                            <div class="mt-6">
                                <a href="<?php echo e(url('profile/' . $user->username . '/portfolio')); ?>" class="active:bg-white active:border-white active:shadow-none bg-white block border border-gray-300 focus:outline-none focus:ring focus:ring-gray-500 focus:ring-opacity-25 font-semibold hover:bg-gray-100 hover:border-gray-300 hover:shadow hover:text-gray-800 leading-5 px-3 py-2 rounded shadow-sm space-x-2 text-center text-gray-800 text-sm"><?php echo e(__('messages.t_view_my_porfolio')); ?></a>
                            </div>
                        <?php endif; ?>
                    ...
                    <section class="px-7 pt-8">
                        ...
                        <div class="text-sm text-gray-500 leading-relaxed">
                            <?php $__currentLoopData = $user->skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(url('hire', $skill->slug)); ?>" class="inline-flex items-center rounded-3xl border border-gray-200 bg-gray-50 px-3.5 py-1.5 text-xs font-normal text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 tracking-wide ltr:[&:not(:last-child)]:mr-1 rtl:[&:not(:last-child)]:ml-1 mb-2 space-x-1 rtl:space-x-reverse dark:bg-zinc-700 dark:hover:bg-zinc-900 dark:border-zinc-700 dark:hover:border-zinc-900 dark:text-zinc-300">
                                    <?php if($skill->experience === 'beginner'): ?>
                                        <svg data-tooltip-target="tooltip-profile-skill-experience-<?php echo e($skill->id); ?>" class="w-3.5 h-3.5 text-blue-500" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 8 16" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M0 8c0-2.2 1.8-4 4-4s4 1.8 4 4-1.8 4-4 4-4-1.8-4-4z"></path></svg>
                                        <?php if (isset($component)) { $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265 = $component; } ?>
<?php $component = App\View\Components\Forms\Tooltip::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.tooltip'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-profile-skill-experience-'.e($skill->id).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_beginner'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php endif; ?>
                                    <?php elseif($skill->experience === 'intermediate'): ?>
                                        <svg data-tooltip-target="tooltip-profile-skill-experience-<?php echo e($skill->id); ?>" class="w-3.5 h-3.5 text-amber-500" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 8 16" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M0 8c0-2.2 1.8-4 4-4s4 1.8 4 4-1.8 4-4 4-4-1.8-4-4z"></path></svg>
                                        <?php if (isset($component)) { $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265 = $component; } ?>
<?php $component = App\View\Components\Forms\Tooltip::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.tooltip'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-profile-skill-experience-'.e($skill->id).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_intermediate'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php endif; ?>
                                    <?php else: ?>
                                        <svg data-tooltip-target="tooltip-profile-skill-experience-<?php echo e($skill->id); ?>" class="w-3.5 h-3.5 text-green-500" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 8 16" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M0 8c0-2.2 1.8-4 4-4s4 1.8 4 4-1.8 4-4 4-4-1.8-4-4z"></path></svg>
                                        <?php if (isset($component)) { $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265 = $component; } ?>
<?php $component = App\View\Components\Forms\Tooltip::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.tooltip'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-profile-skill-experience-'.e($skill->id).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_expert'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-send-custom-offer-container','target' => 'modal-send-custom-offer-button','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'max-w-xl']); ?>

                
                 <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_what_service_are_u_looking_for')); ?> <?php $__env->endSlot(); ?>
...
<?php endif; ?>
                                        ...
                                        <span class="font-medium"><?php echo app('translator')->get('messages.t_attachments_errors'); ?></span>
                                            <ul class="mt-1.5 ltr:ml-4 rtl:mr-4 list-disc list-inside">
                                                <?php $__currentLoopData = $errors->get('attachments'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li wire:key="attachments-errors-item-<?php echo e($key); ?>"><?php echo e($error); ?></li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="p-4 md:p-5 rounded text-slate-700 bg-slate-50">
                                    ...
                                    <ul class="list-inside ltr:ml-8 rtl:mr-8 space-y-2">
                                        ...
                                        <li class="flex items-center text-[13px] tracking-wide">
                                            ...
                                            <?php echo app('translator')->get('messages.t_acceptable_file_types_are'); ?> &nbsp; <b><?php echo e(str_replace(',', ' | ', settings('publish')->custom_offer_attachments_allowed_extensions)); ?></b>
                                        </li>

                                        
                                        <li class="flex items-center text-[13px] tracking-wide">
                                            <svg class="inline-block w-4 h-4 flex-none ltr:mr-2 rtl:pl-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                            <?php echo app('translator')->get('messages.t_the_max_allowable_file_size_is'); ?> &nbsp; <b><?php echo e(settings('publish')->custom_offer_attachment_max_size); ?> <?php echo app('translator')->get('messages.t_size_mb'); ?></b>
                                        </li>

                                        
                                        <li class="flex items-center text-[13px] tracking-wide">
                                            <svg class="inline-block w-4 h-4 flex-none ltr:mr-2 rtl:pl-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                            <?php echo app('translator')->get('messages.t_u_can_upload_max_files'); ?> &nbsp; <b><?php echo e(settings('publish')->custom_offer_attachment_max_files); ?></b>
                                        </li>
                        ...
                        <div class="col-span-12">
                            ...
                            <h3 class="mb-4 text-sm font-medium tracking-wide <?php echo e($errors->first('expected_duration') ? 'text-red-600 dark:text-red-500' : 'text-gray-600 dark:text-white'); ?>"><?php echo app('translator')->get('messages.t_expected_duration'); ?></h3>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="mt-2 text-xs text-red-600 dark:text-red-500"><?php echo e($errors->first('expected_duration')); ?></p>
                            <?php unset($message);
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'sendCustomOffer','text' => ''.e(__('messages.t_submit')).'','block' => 0]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal039608dc70b2e4c26356f5d84408f584)): ?>
<?php $component = $__componentOriginal039608dc70b2e4c26356f5d84408f584; ?>
            ...
            <div class="-mx-6 -my-6 pb-8 pt-10 relative">
                <div class="flex flex-col items-center px-4">
                    ...
                    <div class="sharing-buttons flex flex-wrap -mx-1 justify-center mt-2">
                        ...
                        <a class="bg-[#4267B2] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8" target="_blank" rel="noopener" href="https://facebook.com/sharer/sharer.php?u=<?php echo e(url('profile', $user->username)); ?>" aria-label="Share on Facebook">
                        ...
                        <a class="bg-[#0072b1] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8" target="_blank" rel="noopener" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo e(url('profile', $user->username)); ?>&amp;title=<?php echo e($user->fullname ? $user->fullname : $user->username); ?>&amp;summary=<?php echo e($user->fullname ? $user->fullname : $user->username); ?>&amp;source=<?php echo e(url('profile', $user->username)); ?>" aria-label="Share on Linkedin">
                        ...
                        <a class="bg-[#34526f] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8" target="_blank" rel="noopener" href="https://www.tumblr.com/widgets/share/tool?posttype=link&amp;title=<?php echo e($user->fullname ? $user->fullname : $user->username); ?>&amp;caption=<?php echo e($user->fullname ? $user->fullname : $user->username); ?>&amp;content=<?php echo e(url('profile', $user->username)); ?>&amp;canonicalUrl=<?php echo e(url('profile', $user->username)); ?>&amp;shareSource=tumblr_share_button" aria-label="Share on Tumblr" draggable="false">
                        ...
                        <a class="bg-[#E60023] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8" target="_blank" rel="noopener" href="https://pinterest.com/pin/create/button/?url=<?php echo e(url('profile', $user->username)); ?>&amp;media=<?php echo e(url('profile', $user->username)); ?>&amp;description=<?php echo e($user->fullname ? $user->fullname : $user->username); ?>" aria-label="Share on Pinterest" draggable="false">
                        ...
                        <a class="bg-[#FF5700] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8" target="_blank" rel="noopener" href="https://reddit.com/submit/?url=<?php echo e(url('profile', $user->username)); ?>&amp;resubmit=true&amp;title=<?php echo e($user->fullname ? $user->fullname : $user->username); ?>" aria-label="Share on Reddit" draggable="false">
                        ...
                        <a class="bg-[#126567] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8" target="_blank" rel="noopener" href="https://www.xing.com/app/user?op=share;url=<?php echo e(url('profile', $user->username)); ?>;title=<?php echo e($user->fullname ? $user->fullname : $user->username); ?>" aria-label="Share on Xing" draggable="false">
                        ...
                        <div class="bg-slate-100 rounded p-3 dark:bg-zinc-700">
                            <div tabindex="0" aria-label="copy link" class="focus:outline-none flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-xs ltr:pl-3 ltr:pr-4 rtl:pr-3 rtl:pl-4 leading-3 text-slate-600 dark:text-zinc-300 whitespace-nowrap truncate w-full"><?php echo e(url('profile', $user->username)); ?></p>
                                </div>
        ...
        function rxhfJIyOMMqiyHB() {
            return {
                ...
                async copyProfileLink() {
                    ...
                    // Get profile url
                    let link = "<?php echo e(url('profile', $user->username)); ?>";
                    ...
                    window.$wireui.notify({
                        title      : "<?php echo e(__('messages.t_copied')); ?>",
                        description: "<?php echo e(__('messages.t_profile_link_copied_to_ur_clipboard')); ?>",
                        icon       : 'success'
                    });
                }
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\profile\profile.blade.php ENDPATH**/ ?>