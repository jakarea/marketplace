                        ...
                        <div class="w-full mt-4 grid md:!flex justify-between items-center border-b border-gray-50 dark:border-zinc-700 pb-9 space-y-3 md:space-y-0 space-x-2 rtl:space-x-reverse">
                            ...
                            <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                <?php if($gig->total_orders_in_queue() == 1 || $gig->total_orders_in_queue() == 0): ?>
                                    <?php echo e(__('messages.t_number_order_in_queue', ['number' => $gig->total_orders_in_queue()])); ?>

                                <?php else: ?>
                                    <?php echo e(__('messages.t_number_orders_in_queue', ['number' => $gig->total_orders_in_queue()])); ?>
                    ...
                    <div id="tab-panel-reviews" class="-mb-10" x-data="Components.tabPanel(0)" aria-labelledby="tab-reviews" x-init="init()" x-show="selected" @tab-select.window="onTabSelect" role="tabpanel" tabindex="0">
                        ...
                        <div class="py-6">
                            <?php $__currentLoopData = $gig->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(url('search?q=' . $tag->name)); ?>" class="mb-3 text-xs font-semibold inline-block py-2 px-4 rounded text-slate-600 dark:text-zinc-400 bg-gray-100 dark:bg-zinc-700 dark:hover:bg-zinc-600 hover:bg-gray-200 last:mr-0 ltr:mr-1 rtl:ml-1">
                                    <?php echo e($tag->name); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\service\service.blade.php ENDPATH**/ ?>