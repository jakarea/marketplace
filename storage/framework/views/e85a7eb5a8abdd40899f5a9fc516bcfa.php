            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate -mt-2">
                ...
                <thead>
                    <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="admin-dashboard-messages-<?php echo e($msg->id); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-64 rtl:text-right">
                                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                    <img class="w-10 h-10 rounded-md object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($msg->from->avatar)); ?>" alt="<?php echo e($msg->from->username); ?>">
                                    <div class="space-y-1 font-medium dark:text-white">
                                        <div class="flex items-center space-x-1 rtl:space-x-reverse">

                                            
                                            <a href="<?php echo e(url('profile', $msg->from->username)); ?>" target="_blank" class="font-bold whitespace-nowrap truncate block max-w-[240px] hover:text-zinc-900 dark:text-white text-sm text-zinc-700" title="<?php echo e($msg->from->username); ?>">
                                                <?php echo e($msg->from->fullname ? $msg->from->fullname : $msg->from->username); ?>
                                        ...
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse text-xs font-normal text-gray-400 dark:text-zinc-300">
                                            ...
                                            <a href="<?php echo e(admin_url('users/details/' . $msg->from->uid)); ?>" class="dark:text-zinc-300 whitespace-nowrap hover:text-gray-600 hover:underline">
                                            ...
                                            <a href="<?php echo e(url('profile', $msg->from->username)); ?>" target="_blank" class="dark:text-zinc-300 whitespace-nowrap hover:text-gray-600 hover:underline">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-64 rtl:text-right">
                                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                    <img class="w-10 h-10 rounded-md object-cover lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($msg->to->avatar)); ?>" alt="<?php echo e($msg->to->username); ?>">
                                    <div class="space-y-1 font-medium dark:text-white">
                                        <div class="flex items-center space-x-1 rtl:space-x-reverse">

                                            
                                            <a href="<?php echo e(url('profile', $msg->to->username)); ?>" target="_blank" class="font-bold whitespace-nowrap truncate block max-w-[240px] hover:text-zinc-900 dark:text-white text-sm text-zinc-700" title="<?php echo e($msg->to->username); ?>">
                                                <?php echo e($msg->to->fullname ? $msg->to->fullname : $msg->to->username); ?>
                                        ...
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse text-xs font-normal text-gray-400 dark:text-zinc-300">
                                            ...
                                            <a href="<?php echo e(admin_url('users/details/' . $msg->to->uid)); ?>" class="dark:text-zinc-300 whitespace-nowrap hover:text-gray-600 hover:underline">
                                                <?php echo app('translator')->get('messages.t_user_details'); ?>   
                                            </a>
                                            ...
                                            <a href="<?php echo e(url('profile', $msg->to->username)); ?>" target="_blank" class="dark:text-zinc-300 whitespace-nowrap hover:text-gray-600 hover:underline">
                                                <?php echo app('translator')->get('messages.t_view_profile'); ?>    
                                            </a>
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                <div class="text-gray-600 dark:text-gray-100 text-sm font-medium whitespace-nowrap">
                                    <?php echo e(format_date($msg->created_at)); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-view-'.e($msg->id).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_view'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <div>
                                        <button type="button" wire:click="confirmDelete('<?php echo e($msg->id); ?>')" data-tooltip-target="tooltip-actions-delete-<?php echo e($msg->id); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-red-600 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-700 dark:hover:bg-zinc-900 dark:hover:border-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-delete-'.e($msg->id).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_delete'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-view-container-'.e($msg->id).'','target' => 'modal-view-button-'.e($msg->id).'','uid' => 'modal_msg_details_'.e($msg->id).'','placement' => 'center-center','size' => 'max-w-xl']); ?>
                                ...
                                <div class="w-full divide-y divide-gray-300 space-y-8">
                                    ...
                                    <?php if($msg->attachment): ?>
                                        <div class="w-full pb-4">
                                            ...
                                            <span class="<?php echo e($msg->body ? 'mt-8' : ''); ?> mb-2 block text-sm font-bold tracking-wide text-zinc-700"><?php echo app('translator')->get('messages.t_attachment'); ?></span>
                                            ...
                                            <div class="mt-6 flex">
                                                ...
                                                <div class="w-10 flex flex-col items-center">
                                                    <div class="fiv-sqo fiv-icon-<?php echo e($attachment->extension); ?> text-4xl"></div>
                                                </div>
                                                ...
                                                <div class="ltr:pl-3 rtl:pr-3">
                                                    ...
                                                    <p class="focus:outline-none text-sm font-semibold leading-normal text-gray-800 pb-1 -mt-1 dark:text-zinc-200">
                                                        <?php echo e($attachment->old_name); ?>
                                                    ...
                                                    <div class="focus:outline-none text-xs leading-3 text-gray-500 pt-1 space-x-2 rtl:space-x-reverse dark:text-zinc-400">
                                                        ...
                                                        <a href="<?php echo e(url('inbox/download', $attachment->new_name)); ?>" class="text-primary-600 hover:underline"><?php echo app('translator')->get('messages.t_download'); ?></a>

                                                        
                                                        <span class="text-gray-300 dark:text-zinc-600" aria-hidden="true">|</span>

                                                        
                                                        <span><?php echo e(human_filesize($attachment->size)); ?></span>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\admin\conversations\conversations.blade.php ENDPATH**/ ?>