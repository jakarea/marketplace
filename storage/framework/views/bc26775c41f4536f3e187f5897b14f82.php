            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate sm:mt-2">
                ...
                <thead>
                    <?php $__empty_1 = true; $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="freelancer-dashboard-offers-<?php echo e($offer->uid); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-52 rtl:text-right">
                                <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                    ...
                                    <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($offer->buyer->avatar)); ?>" alt="<?php echo e($offer->buyer->username); ?>" class="w-7 h-7 rounded-full object-cover lazy">
...
<?php endif; ?>
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button" data-tooltip-target="tooltip-actions-reject-<?php echo e($offer->uid); ?>" id="modal-reject-offer-button-<?php echo e($offer->uid); ?>" class="flex items-center justify-center h-6 w-6 rounded-full border border-transparent bg-yellow-50 text-yellow-600 hover:bg-transparent hover:border-yellow-600 dark:bg-yellow-600 dark:text-yellow-300 dark:hover:bg-transparent">
...
<?php endif; ?>
                                    ...
                                    <div>
                                        <a href="<?php echo e(url('messages/new', $offer->buyer->username)); ?>" target="_blank" data-tooltip-target="tooltip-actions-chat-<?php echo e($offer->uid); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-700 dark:hover:bg-zinc-900 dark:hover:border-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100">
...
<?php endif; ?>
                                    ...
                                    <?php if( in_array($offer->freelancer_status, ['completed', 'approved']) && in_array($offer->payment_status, ['funded', 'released']) ): ?>
                                        <div>
                                            <button type="button" id="modal-offer-work-button-<?php echo e($offer->uid); ?>" data-tooltip-target="tooltip-actions-deliver-<?php echo e($offer->uid); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-700 dark:hover:bg-zinc-900 dark:hover:border-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-deliver-'.e($offer->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_send_a_file'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php endif; ?>
                                    ...
                                    <?php if( $offer->freelancer_status === 'approved' && !$offer->isDelivered() && in_array($offer->payment_status, ['pending', 'funded']) ): ?>
                                        <div>
                                            <button type="button" wire:click="confirmCancel('<?php echo e($offer->uid); ?>')" data-tooltip-target="tooltip-actions-cancel-<?php echo e($offer->uid); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-700 dark:hover:bg-zinc-900 dark:hover:border-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-cancel-'.e($offer->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_cancel_order'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265)): ?>
<?php $component = $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265; ?>
...
<?php $component->withAttributes(['id' => 'modal-approve-offer-container-'.e($offer->uid).'','target' => 'modal-approve-offer-button-'.e($offer->uid).'','uid' => 'modal_approve_offer_'.e($offer->uid).'','placement' => 'center-center','size' => 'max-w-md']); ?>
                                 ...
                                 <?php $__env->slot('title', null, []); ?> <?php echo e(__('messages.t_accept_offer')); ?> <?php $__env->endSlot(); ?>
                                 ...
                                 <?php $__env->slot('footer', null, []); ?> 
                                    <div class="flex justify-between items-center w-full">
                                        ...
                                        <button
                                            type="button" 
                                            wire:click="accept('<?php echo e($offer->uid); ?>')"
                                            ...
                                            <div wire:loading wire:target="accept('<?php echo e($offer->uid); ?>')">
                                            ...
                                            <div wire:loading.remove wire:target="accept('<?php echo e($offer->uid); ?>')">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                            <p class="mt-1.5 text-[13px] tracking-wide text-red-600 font-medium ltr:pl-1 rtl:pr-1">
                                                <?php echo e($errors->first('reject_reason')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-offer-work-container-'.e($offer->uid).'','target' => 'modal-offer-work-button-'.e($offer->uid).'','uid' => 'modal_offer_work_'.e($offer->uid).'','placement' => 'center-center','size' => 'max-w-xl']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'sendFile(\''.e($offer->uid).'\')','text' => ''.e(__('messages.t_submit')).'','block' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                                            ...
                                            <div class="w-full space-y-3">
                                                <?php $__currentLoopData = $offer->work; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="border border-slate-200 dark:border-zinc-700 px-3 py-4 rounded-md">
                                                        <div class="flex items-center justify-between w-full" wire:key="seller-submitted-offer-files-<?php echo e($file->uid); ?>">
                                                            <div class="flex items-center">
                                                            ...
                                                            <div class="relative">
                                                                <a href="<?php echo e(url('uploads/offers/work', $file->uid . '.' . $file->file_extension)); ?>" class="focus:outline-none">
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\seller\offers\offers.blade.php ENDPATH**/ ?>