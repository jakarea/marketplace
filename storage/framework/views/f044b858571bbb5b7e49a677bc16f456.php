...
} elseif ($_instance->childHasBeenRendered('l228699755-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l228699755-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l228699755-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l228699755-1');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('l228699755-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l228699755-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l228699755-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l228699755-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l228699755-2');
} else {
    $response = \Livewire\Livewire::mount('main.partials.cart');
    $html = $response->html();
    $_instance->logRenderedChild('l228699755-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
         ...
         <nav class="navbar header-section navbar-expand-xl navbar-light">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <div class="d-flex">
          ...
          <a href="#" class="bttn-login">Log In</a>
          <a href="#" class="bttn-regis">Sign Up</a>
        </div>
      </div>
    </div>
  </nav>
...
<?php endif; ?>
 ...
 <?php $__env->stopPush(); ?>
 <?php /**PATH /Applications/MAMP/htdocs/riverr/resources/views/livewire/main/includes/header.blade.php ENDPATH**/ ?>