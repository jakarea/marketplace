                            ...
                            <div id="change-footer-language-dropdown" class="z-10 hidden bg-white rounded-md border w-48 dark:bg-zinc-800 dark:border-zinc-700">
                                <ul class="text-gray-700 dark:text-gray-200">
                                    <?php $__currentLoopData = supported_languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li wire:key="footer-languages-id-<?php echo e($lang->language_code); ?>" <?php if($default_language_code !== $lang->language_code): ?> wire:click="setLocale('<?php echo e($lang->language_code); ?>')" <?php endif; ?> class="py-2.5 px-4 flex w-full items-center cursor-pointer justify-between <?php echo e($default_language_code === $lang->language_code ? 'bg-blue-50 text-blue-600 dark:bg-zinc-700 dark:text-white' : 'hover:bg-gray-50 dark:hover:bg-zinc-700'); ?> focus:outline-none first:rounded-t-md last:rounded-b-md">
                                            <div class="inline-flex items-center">
                                                ...
                                                <span class="font-medium text-[13px] tracking-wide"><?php echo e($lang->name); ?></span>
                                            </div>
...
</footer><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\includes\footer.blade.php ENDPATH**/ ?>