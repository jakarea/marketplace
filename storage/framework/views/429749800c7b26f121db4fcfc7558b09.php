                        ...
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="freelancer-dashboard-gigs-<?php echo e($gig->uid); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                ...
                                <?php if($gig->total_orders_in_queue() == 1): ?>
                                    <p class="text-xs text-gray-400 tracking-wide font-normal mt-1 whitespace-nowrap"><?php echo e(__('messages.t_number_order_in_queue', ['number' => $gig->total_orders_in_queue()])); ?></p>
                                <?php else: ?>
                                    <p class="text-xs text-gray-400 tracking-wide font-normal mt-1 whitespace-nowrap"><?php echo e(__('messages.t_number_orders_in_queue', ['number' => $gig->total_orders_in_queue()])); ?></p>
                                <?php endif; ?>
                            </td>
                                ...
                                <?php switch($gig->status):
                                    ...
                                    <?php case ('rejected'): ?>
                                        <span class="whitespace-nowrap inline-flex items-center px-2.5 py-1 rounded-sm text-xs font-medium bg-red-50 text-red-800 dark:bg-transparent dark:text-red-400">
                                            <?php echo e(__('messages.t_needs_changes')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tooltip-actions-rejection-'.e($gig->uid).'','text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_rejection_reason'))]); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-rejection-reason-container-'.e($gig->uid).'','target' => 'modal-rejection-reason-button-'.e($gig->uid).'','uid' => 'modal_'.e(uid()).'','placement' => 'center-center','size' => 'max-w-md']); ?>
                                 ...
                                 <?php $__env->slot('content', null, []); ?> 
                                    ...
                                    <div class="text-sm text-gray-500 dark:text-zinc-300 leading-relaxed">
                                        <?php echo e($gig->rejection_reason); ?>
...
</div><?php /**PATH C:\Users\Pc\Desktop\1.3.3\resources\views\livewire\main\seller\gigs\gigs.blade.php ENDPATH**/ ?>